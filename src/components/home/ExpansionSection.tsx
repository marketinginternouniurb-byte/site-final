...
const LEGACY_PROJECTS = [
  {
    ...
    link: "https://universalurbanismo.com/lote/dona-augusta/",
    year: "Legado",
    status: "100% Vendido",
  },
  {
    id: "leg-2",
    title: "Loteamento Universo",
    location: "Cariacica - ES",
    image_url:
      "https://images.unsplash.com/photo-1582407947304-fd86f028f716?q=80&w=800&auto=format&fit=crop",
    link: "https://universalurbanismo.com/lote/universo/",
    year: "Legado",
    status: "100% Vendido",
  },
  {
    ...
    link: "https://universalurbanismo.com/lote/vista-de-vioria/",
    year: "Legado",
    status: "100% Vendido",
  },
  {
    ...
    link: "https://universalurbanismo.com/lote/vista-da-ilha/",
    year: "Legado",
    status: "100% Vendido",
  },
];
...
export default function ExpansionSection() {
  ...
  return (
    <section
      id="ancora-lotes"
      className="py-24 px-6 relative overflow-hidden bg-[#FAF9F6] scroll-mt-20 antialiased"
    >
      <div
        className="absolute inset-0 z-0 opacity-40 mix-blend-multiply pointer-events-none"
        style={{
          backgroundImage:
            "url('https://ftalrdptjbzmpxjgbzpq.supabase.co/storage/v1/object/public/project-images/Toalha.png')",
          backgroundSize: "cover",
        }}
      />
      <div className="absolute inset-0 z-0 bg-gradient-to-b from-[#FAF9F6]/90 via-transparent to-[#FAF9F6]/90" />

      <div className="max-w-7xl mx-auto relative z-10">
        <header className="text-center mb-20 flex justify-center w-full">
          <h2
            className="flex flex-row flex-nowrap items-center justify-center gap-x-3 sm:gap-x-4 text-[#123AAA]"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-32">
          {projects.map((p) => {
            const media = Math.round(
              ((p.progresso_agua || 0) +
                (p.progresso_saneamento || 0) +
                (p.progresso_pavimentacao || 0) +
                (p.progresso_energia || 0)) /
                4
            );
            ...
            return (
              <div
                key={p.id}
                className="group relative flex flex-col bg-white rounded-[32px] p-2.5 border border-white shadow-xl transition-all hover:shadow-2xl hover:-translate-y-1 overflow-hidden"
              >
                <div
                  className="absolute inset-0 z-0 pointer-events-none"
                  style={{
                    backgroundImage:
                      "url('https://ftalrdptjbzmpxjgbzpq.supabase.co/storage/v1/object/public/project-images/Toalha%20(1).png')",
                    backgroundSize: "cover",
                  }}
                />
                ...
                <div className="relative h-44 rounded-[20px] overflow-hidden bg-gray-100 z-10 shadow-sm">
                  <img
                    src={getOptimizedImageUrl(p.image_url, { width: 700 })}
                    alt={p.title}
                    loading="lazy"
                    decoding="async"
                  ...
                  <div className="absolute top-3 left-3 bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-lg shadow-md border-l-4 border-[#FFD700]">
                    <span className="text-[#123AAA] text-[8px] font-black uppercase tracking-widest">
                      {p.status}
                    </span>
                  </div>
                  ...
                  {isPreLaunch && (
                    <div className="absolute top-3 right-3 bg-[#FFD700] px-3 py-1.5 rounded-lg shadow-md flex items-center gap-1.5 border border-white/20">
                      ...
                      <span className="text-[#123AAA] text-[10px] font-black uppercase tracking-widest">
                        FACILITA
                      </span>
                    </div>
                  )}
                ...
                <div className="p-5 space-y-5 flex-grow flex flex-col relative z-10">
                  <div>
                    <h3 className="text-xl font-black text-[#123AAA] uppercase italic tracking-tighter mb-1 line-clamp-1">
                      {p.title}
                    </h3>
                  ...
                  <div className="flex gap-6 pt-4 border-t border-slate-100">
                    <div className="flex flex-col flex-1">
                      <span className="text-[9px] text-[#123AAA] font-black uppercase tracking-widest mb-1">
                        Lotes
                      </span>
                      <span className="text-2xl font-black text-[#123AAA] leading-none">
                        {p.lotes_totais}
                      </span>
                    </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {LEGACY_PROJECTS.map((p) => (
              <div
                ...
                className="group relative bg-white rounded-[24px] p-2 border border-slate-50 shadow-md hover:shadow-xl transition-all overflow-hidden flex flex-col cursor-pointer hover:-translate-y-1"
              >
                <div
                ...
                <div className="relative h-40 rounded-[18px] overflow-hidden z-10">
                  <img
                    src={getOptimizedImageUrl(p.image_url, { width: 500 })}
                    alt={p.title}
                    loading="lazy"
                    decoding="async"
                ...
                <div className="p-4 z-10 flex-grow flex flex-col justify-between bg-white/80">
                  <h3 className="text-sm font-black text-[#123AAA] uppercase tracking-tighter mb-1 line-clamp-1">
                    {p.title}
                  </h3>
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-100 flex justify-between items-center">
                    <span className="text-[10px] font-black text-[#123AAA]/40 uppercase tracking-widest">
                      {p.year}
                    </span>
                    <ExternalLink
                      size={14}
                      className="text-[#123AAA]/30 group-hover:text-[#FFD700] transition-colors"
                    />
                  </div>
                </div>
              </div>
